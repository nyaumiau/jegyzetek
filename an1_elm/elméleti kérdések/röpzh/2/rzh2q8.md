...
$$\{x \in D_g \space  | \space g(x) \in D_f\} \neq \emptyset.$$Ebben az esetben az $f$ (*külső*) és $g$ (*belső*) függvény *összetett függvényét* (vagy más szóval $f$ és $g$ *kompozícióját*) $f \circ g$ -vel jelöljük és így értelmezzük:
