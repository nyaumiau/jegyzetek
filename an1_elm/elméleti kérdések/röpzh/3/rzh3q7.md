...
Azt mondjuk, hogy az $(a_n)$ sorozatnak *tágabb értelemben van határtértéke*, ha: $$\exists A \in \mathbb{\overline{R}} : \forall ε > 0 : \exists n_0 \in \mathbb{N} : \forall n \gt n_0 : a_n \in K_ε (A).$$*Megjegyzés:*
