...
Tegyük fel, hogy a $\sum a_n$ végtelen sor egyik tagja sem $0$, valamint, hogy létezik az $$A:=\lim_{n \rightarrow +\infty} \sqrt[n]{|{\dfrac{a_{n+1}}{a_n}}|}\in \mathbb{\overline{R}}$$határérték. Ekkor:
